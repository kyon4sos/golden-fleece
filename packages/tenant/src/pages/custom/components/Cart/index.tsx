...
const Cart = ({ open, onClose }: Props) => {
    ...
    // }, [open])
    const _onClose = (val) => {
        console.log('click _onClose',val);
        // onClose(val)
        // setOpen(val)
    }

    return (
        <Dialog open={open} onClose={() => _onClose(false)}>
            <Dialog.Panel>
                ...
                <button onClick={() => _onClose(false)}>Deactivate</button>
                <button onClick={() => _onClose(false)}>Cancel</button>
            </Dialog.Panel>
        </Dialog>
